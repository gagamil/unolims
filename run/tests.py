...
from .const import RUN_METHOD__SALIVECLEAR, RUN_METHOD_TARGETS__SALIVECLEAR, RUN_REPLICATION__DUPLICATE, RUN_REPLICATION__TRIPLICATE
from .services import create_well_plate_template
...
class RunCreateTestCase(TestCase):
    ...
    def test_with_tube_batch_ok(self):
        pass
